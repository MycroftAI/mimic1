...
extern uint16_t * cmu_us_rms_single_model_vectors[];
extern const dur_stat * cmu_us_rms_dur_stats[];
...
uint16_t **cmu_us_rms_model_vectors[] = {
    cmu_us_rms_single_model_vectors
};
const cst_cart * const *cmu_us_rms_mcep_carts[] = {
